...
from CameraPackageSupport import WebCamService, routes
from CameraPackageSupport.camera_1 import camera_1
from CameraPackageSupport.camera_2 import camera_2
